...
#mlp = MLPClassifier(solver='lbfgs', random_state=0, hidden_layer_sizes=[10, 10], alpha = 0.0001 )

#mlp = MLPClassifier(solver='lbfgs', random_state=0, hidden_layer_sizes=[10, 2], alpha = 0.0001 )
